...
public class CampoMinado
{
    ...
    public static void criarCampo(Campo[] vetor){ //função que preenche o vetor
        for(int i=0; i<100; i++){
            vetor[i] = new Campo();
    ...
    public static void mostrarCampo(Campo[] vetor){ //função que imprime o vetor
        System.out.print("\n\nCampo Minado: \n");
        for(int i=0; i<100; i++){
    ...
    public static int confereCampo(Campo[] vetor, int chute, int pontos){ //função que verifica se o chure do usuário
            if(vetor[chute].numero%2 == 0 & vetor[chute].status.equals("?")){
                vetor[chute].status = "-";
                pontos ++;
                for(int i = chute-1; i>=0; i--){ //laço que olha os números anteriores ao chute até encontrar o primeiro impar ou o início do vetor
                ...
                for(int i = chute+1; i< 100; i++){ // laço que olha os números posteriores até encontrar o primeiro impar ou o início do vetor
                    if(  vetor[i].numero % 2 == 0){
                        vetor[i].status = "-";
                        pontos ++;
                    }
